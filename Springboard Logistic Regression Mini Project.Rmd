...
```{r}
NH11<-readRDS("~/Downloads/NatHealth2011.rds")
...
NH11$hpev<-factor(NH11$hypev,levels=c("2 No","1 Yes"))
...
## this gives me an error when i run it says it can't find effects
...
library("effects")
data.fram(Effect("r_maritl",EverWorked))
